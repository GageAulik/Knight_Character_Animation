...
public class TwoDimensionalAnimationStateController : MonoBehaviour
{
    ...
    public float maxiumumWalkVelocity = 0.5f;
    public float maxiumumRunVelocity = 2.0f;
    ...
    void Update()
    {
        ...
        float currentMaxVelocity = runPressed ? maxiumumRunVelocity : maxiumumWalkVelocity;
